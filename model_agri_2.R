...
modis<-subset(modis,distance>0.51&agri>0.9)
...
########################
### Create the mesh 
b1<-inla.nonconvex.hull(loc,convex=0.25,concave=-0.5)
...
matern= inla.spde2.pcmatern(mesh,prior.range = c(10, 0.05),
